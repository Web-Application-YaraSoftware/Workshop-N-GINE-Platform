...
public class InterventionResourceFromEntityAssembler
{
    ...
    {
        return new InterventionResource(entity.Id, entity.VehicleId, entity.MechanicLeaderId, entity.Description, entity.TypeToString(), entity.StatusToString(), entity.StartedAt, entity.FinishedAt);
    }
}